...
from app.embeddings.dataset import TextDataset
...
class TrainModule:
    ...
    def __init__(
        ...
        # 1. Cargar Tokenizer
        self.tokenizer = BPETokenizer.load(str(self.config.ASSETS_DIR / "model_tokens.json"))
    ...
    def train(self):
        ...
        model_path = self.config.MODELS_DIR / f"{self.model_name}.pth"
